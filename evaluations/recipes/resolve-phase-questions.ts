...
const stateFile = join(tmpdir(), `eval-resolve-phase-questions-${Date.now()}.json`)
  ...
  pendingQuestions: [
    {
      ...
      context: 'Needed to determine how to write tests for the notification task.',
    },
    {
      id: 'q2',
      phaseIndex: 0,
      question: 'What is the name of the npm package published by this project?',
