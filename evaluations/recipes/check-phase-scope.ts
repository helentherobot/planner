...
console.log(`check-phase-scope — profile: ${profileName}`)
console.log()

for (const fixture of fixtures.scope) {
  ...
  const raised = result.phases[0]?.controls?.scope?.raised ?? []
