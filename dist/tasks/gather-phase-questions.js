...
export async function handleGatherPhaseQuestions(task, state, adapters) {
    ...
    for (let i = 0; i < questions.length; i++) {
        ...
        const existingIndex = updatedPending.findIndex((p) => p.question.trim().toLowerCase() === normalised);
        if (existingIndex !== -1) {
